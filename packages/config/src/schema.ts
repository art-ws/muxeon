...
import type { CommandGrantsMap, SessionGrantsMap } from "@muxeon/core";
...
export interface MuxeonConfig {
   ...
   * the web panel topbar and page title (`<name> - Muxeon`). Absent ⇒ the server
...
export function validateStructure(value: unknown): MuxeonConfig {
