...
//               (slash commands / console), lifecycle actions;
 ...
 * the read-only projection: an agent surface WITHOUT the console (no slash/
...
/** Whether this peer has a console behind it: slash commands, the terminal (§12.9). */
